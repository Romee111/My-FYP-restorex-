...
const LoginModal = ({ setIsUserLoggedIn }) => {
  ...
  const [isModalOpen, setIsModalOpen] = useState(!localStorage.getItem('user')); // Show modal if no user is logged in
  ...
  const handleCloseModal = () => {
    setIsModalOpen(false); // Allow user to close modal manually
  };
